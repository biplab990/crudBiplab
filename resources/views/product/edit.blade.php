        ...
        <div class="card-body">
            <form method="post" enctype="multipart/form-data" action="{{ route('product.update',$product->id) }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{old('productName',$product->name)}}" class="form-control" id="productName" name="productName"/>
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row justify-content-end">
                    <div class="col-sm-10">
                        ...
                        <img width="100px" class="float-end" src="{{ asset('uploads/product/'.$product->image) }}" alt="">
                    </div>
                </div>
            </form>
        </div>
